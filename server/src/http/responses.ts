...
export const simulationRunResponseSchema = z.object({ run: simulationRunSchema })

export const simulationRunListResponseSchema = z.object({ runs: z.array(simulationRunSchema) })
...
export const simulationQuotaResponseSchema = z.object({ quota: simulationQuotaSchema })
